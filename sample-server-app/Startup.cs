...
namespace Autodesk.Forge.Samples
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                throw new ApplicationException("Missing environment variables FORGE_CLIENT_ID or FORGE_CLIENT_SECRET.");
            }
            services.AddSingleton<IForgeService>(new ForgeService(ForgeClientID, ForgeClientSecret));
        }
